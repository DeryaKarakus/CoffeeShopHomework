...
public class RHKExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(RHKDateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new RHKStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static RHKDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static RHKDateTimeConverter dateTimeConverter = new RHKStandardDateTimeConverter();

    public RHKExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public RHKExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new RHKMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=RHKHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,RHKExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=RHKHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
