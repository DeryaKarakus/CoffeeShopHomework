...
public class RHKKPSPublicSoap
{
    interface RHKIWcfMethod
    {
        RHKExtendedSoapSerializationEnvelope CreateSoapEnvelope() throws java.lang.Exception;

        java.lang.Object ProcessResult(RHKExtendedSoapSerializationEnvelope __envelope,java.lang.Object result) throws java.lang.Exception;
    }
    ...
    public RHKKPSPublicSoap(){}

    public RHKKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public RHKKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    protected RHKExtendedSoapSerializationEnvelope createEnvelope()
    {
        RHKExtendedSoapSerializationEnvelope envelope= new RHKExtendedSoapSerializationEnvelope(RHKExtendedSoapSerializationEnvelope.VER11);
        envelope.enableLogging = enableLogging;
    
        return envelope;
    }

    protected java.util.List sendRequest(String methodName,RHKExtendedSoapSerializationEnvelope envelope,org.ksoap2.transport.Transport transport ,com.easywsdl.exksoap2.ws_specifications.profile.WS_Profile profile )throws java.lang.Exception
    {
    ...
    java.lang.Object getResult(java.lang.Class destObj,java.lang.Object source,String resultName,RHKExtendedSoapSerializationEnvelope __envelope) throws java.lang.Exception
    {
        if(source==null)
        {
            return null;
    ...
    public Boolean TCKimlikNoDogrula(final String TCKimlikNo, final String Ad, final String Soyad, final int DogumYili) throws java.lang.Exception
    {
        ...
        return (Boolean)execute(new RHKIWcfMethod()
        {
            @Override
            public RHKExtendedSoapSerializationEnvelope CreateSoapEnvelope(){
                RHKExtendedSoapSerializationEnvelope __envelope = createEnvelope();
            ...
            @Override
            public java.lang.Object ProcessResult(RHKExtendedSoapSerializationEnvelope __envelope,java.lang.Object __result)throws java.lang.Exception {
    ...
    protected java.lang.Object execute(RHKIWcfMethod wcfMethod,String methodName,com.easywsdl.exksoap2.ws_specifications.profile.WS_Profile profile) throws java.lang.Exception
    {
        org.ksoap2.transport.Transport __httpTransport=createTransport();
        __httpTransport.debug=enableLogging;
        RHKExtendedSoapSerializationEnvelope __envelope=wcfMethod.CreateSoapEnvelope();
        try
        {
    ...
    protected java.lang.Exception convertToException(org.ksoap2.SoapFault fault,RHKExtendedSoapSerializationEnvelope envelope)
    {
