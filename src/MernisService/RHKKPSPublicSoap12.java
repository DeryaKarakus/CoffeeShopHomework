...
public class RHKKPSPublicSoap12
{
    ...
    public RHKKPSPublicSoap12(){}

    public RHKKPSPublicSoap12(String url)
    {
        this.url = url;
    }

    public RHKKPSPublicSoap12(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        RHKExtendedSoapSerializationEnvelope envelope= new RHKExtendedSoapSerializationEnvelope(RHKExtendedSoapSerializationEnvelope.VER12);
